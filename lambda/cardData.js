...
const cards = {
    ...
    21: { age: 1, name: 'Barracks',    color: "red", cost: { resources: ["ore"] }, effects: [{ type: "shields", shields: 1 }] },
    22: { age: 1, name: 'Stockade',    color: "red", cost: { resources: ["wood"] }, effects: [{ type: "shields", shields: 1 }] },
    23: { age: 1, name: 'Guard Tower', color: "red", cost: { resources: ["clay"] }, effects: [{ type: "shields", shields: 1 }] },
    ...
    42: { age: 2, name: 'Stables',     color: "red", cost: { resources: ["wood", "ore", "clay"], chain: "horseshoe" }, effects: [{ type: "shields", shields: 2 }] },
    43: { age: 2, name: 'Walls',       color: "red", cost: { resources: ["stone", "stone", "stone"] }, effects: [{ type: "shields", shields: 2 }], chains: ["fortress"] },
    44: { age: 2, name: 'Archery Range', color: "red", cost: { resources: ["wood", "wood", "ore"], chain: "target" }, effects: [{ type: "shields", shields: 2 }] },
    45: { age: 2, name: 'Training Ground', color: "red", cost: { resources: ["ore", "ore", "wood"] }, effects: [{ type: "shields", shields: 2 }], chains: ["helmet"] },
    ...
    67: { age: 3, name: 'Haven',       color: "yellow", cost: { resources: ["wood", "ore", "loom"], chain: "barrel" }, effects: [{ type: "gold_and_points_for_cards", color: "brown", gold_per_card: 1, points_per_card: 1 }] },
    ...
    70: { age: 3, name: 'Circus',      color: "red", cost: { resources: ["stone", "stone", "stone", "ore"], chain: "helmet" }, effects: [{ type: "shields", shields: 3 }] },
    71: { age: 3, name: 'Arsenal',     color: "red", cost: { resources: ["wood", "wood", "ore", "loom"] }, effects: [{ type: "shields", shields: 3 }] },
    72: { age: 3, name: 'Fortifications', color: "red", cost: { resources: ["ore", "ore", "ore", "clay"], chain: "fortress" }, effects: [{ type: "shields", shields: 3 }] },
    73: { age: 3, name: 'Siege Workshop', color: "red", cost: { resources: ["clay", "clay", "clay", "wood"], chain: "saw" }, effects: [{ type: "shields", shields: 3 }] },
    74: { age: 3, name: 'Castrum',     color: "red", cost: { resources: ["clay", "clay", "wood", "press"] }, effects: [{ type: "shields", shields: 3 }] },
    ...
    86: { age: 1, name: 'Raider Camp', color: "black", effects: [{ type: "debt_for_neighbor", direction: "neg" }, { type: "gain_military_token", token_value: 1 }, { type: "debt_for_neighbor", direction: "pos" }] },
    87: { age: 1, name: 'Cells',       color: "black", effects: [{ type: "points_for_victory_tokens", token_value: 1, points_per_token: 2 }] },
    88: { age: 1, name: 'Militia',     color: "black", cost: { gold: 3 }, effects: [{ type: "shields", shields: 2 }] },
    ...
    100: { age: 2, name: 'Raider Fort', color: "black", cost: { resources: ["ore", "clay"], gold: 1 }, effects: [{ type: "debt_for_neighbor", direction: "neg" }, { type: "gain_military_token", token_value: 3 }, { type: "debt_for_neighbor", direction: "pos" }] },
    ...
    102: { age: 2, name: 'Mercenaries', color: "black", cost: { resources: ["press"], gold: 4 }, effects: [{ type: "shields", shields: 3 }] },
    ...
    114: { age: 3, name: 'Raider Garrison', color: "black", cost: { resources: ["stone", "stone", "loom"], gold: 2 }, effects: [{ type: "debt_for_neighbor", direction: "neg" }, { type: "gain_military_token", token_value: 5 }, { type: "debt_for_neighbor", direction: "pos" }] },
